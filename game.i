...
void drawMordecai() {
        ...
        shadowOAM[0].attr1 = mordecai.col | (2<<14);
...
void drawAttack(ATTACK* a) {
    if(a->active) {
        shadowOAM[3].attr0 = a->row | (0<<8) | (0<<14) | (0<<13);
        shadowOAM[3].attr1 = a->col | (2<<14);
        shadowOAM[3].attr2 = ((0)*32+(12));
 }
...
void drawCoin() {
    if (coin.active) {
        ...
        shadowOAM[1].attr1 = coin.col | (2<<14);
...
void drawGbf() {
    if (gbf.active) {
        shadowOAM[2].attr0 = gbf.row | (0<<8) | (0<<14) | (0<<13);
        shadowOAM[2].attr1 = gbf.col | (2<<14);
